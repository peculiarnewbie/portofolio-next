        ...
        <div id="top" className="flex-col w-[120%] h-[80vh] px-[10%] ">
            ...
            <div className="flex items-end h-2/3 sm:h-3/5">
                <div className="relative bottom-0 w-full items-center dark:text-white">
                    <h1 onClick={ToggleDark} className="font-semibold text-7xl md:text-9xl md:text-center">Hi!</h1>
            ...
            <div className="flex w-full h-8 justify-center">
                <div className="flex h-full w-fit justify-center gap-12 dark:invert">
